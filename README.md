...
## V3.0.5 — بث السعر وحفظ الشموع

- السعر المباشر عبر SignalR للمزود نفسه، لا يُحسب ضمن طلبات REST حسب وثائق المزود. إذا تعذر الاتصال، يستخدم التطبيق REST فقط عند الحاجة ضمن حد 10,000 طلب/UTC يوميًا؛ حد المصدر الخارجي مستقل.
- شارة LIVE تعني سعرًا حديثًا صالحًا، أما قرار BUY/SELL/WAIT فيظل تابعًا لاستقلال التدريب والاختبار وجودة الشموع ومحرك المخاطر. قد يظهر LIVE مع WAIT عند GAP_H1.
- حفظ شموع OHLC المكتملة من المصدر محليًا، ودمجها مع استجابة المصدر التالية إذا سقطت من سجل المزود، مع السماح لتصحيحات المصدر بأولوية أعلى. لا تُختلق الشمعة المفقودة عند الإغلاق المبكر يوم 21 سبتمبر.
- سجل المصدر المرفق فيه 48 عينة ذهب صالحة و59 نتيجة استبعدت لفجوات الرصد؛ Validation يحتوي صفقة واحدة مقبولة، لذلك لا يمكن ترقية نموذج اعتمادًا عليه بعد. البث المستمر يحسّن جمع النتائج اللاحقة عندما يبقى التطبيق نشطًا.
