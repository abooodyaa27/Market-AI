...
test('derived M15 cannot independently reject continuity already validated on M5',()=>{const src=require('fs').readFileSync(require('path').join(__dirname,'../app/src/main/assets/features.js'),'utf8');assert.match(src,/kind==='BAD'&&tf!=='M15'/);});
