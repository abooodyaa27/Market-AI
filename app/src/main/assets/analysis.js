...
function analyze(input){
 ...
 const c5=liveM5.at(-1),c1=liveM1.at(-1),baseA5=atr(closed.M5),baseA1=atr(closed.M1);
 const useLive5=!!(c5&&c5[5]===true&&positive(baseA5)&&((c5[2]-c5[3])>=.05*baseA5||Math.abs(c5[4]-c5[1])>=.03*baseA5));
 const useLive1=!!(c1&&c1[5]===true&&positive(baseA1)&&((c1[2]-c1[3])>=.04*baseA1||Math.abs(c1[4]-c1[1])>=.025*baseA1));
 const execM5=useLive5?liveM5:closed.M5,execM1=useLive1?liveM1:closed.M1;
