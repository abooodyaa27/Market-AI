...
chartEl.addEventListener('pointerup',e=>{window.MarketChart.end();chartEl.releasePointerCapture?.(e.pointerId);});
chartEl.addEventListener('pointercancel',()=>window.MarketChart.end());
